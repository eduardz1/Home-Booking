...
VALUES ('iman.solaih@edu.unito.to', 1, '2022-10-06', '2021-10-13', 0);
...
VALUES ( 2, 'eduard.occhipinti@edu.unito.to', '2022-01-05', 'Marco è stato un grande ospite, mi ha aiutato in tutti i progetti', 5, 'Utente');
...
DELETE FROM Alloggio WHERE IDAlloggio = 1;
