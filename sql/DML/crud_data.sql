INSERT INTO Utente (Nome, Cognome, Email, Password, Host, SuperHost) VALUES ('Marco', 'Molica', 'marco.molica@ehostone.it', 'a', FALSE, TRUE);
...
INSERT INTO Utente (Nome, Cognome, Email, Password, Verificato) VALUES ('Marco', 'Molica', 'marco.molica@verificatone.it', 'a', TRUE);
...
VALUES ('iman.solaih@edu.unito.to', '97c645ea-e19c-411c-8539-5d21def970cc', '2022-10-06', '2021-10-13', 0);
...
INSERT INTO Recensione (IDPrenotazione, Autore, DataRecensione, Corpo, ValutazionePosizione, Categoria)
VALUES ( '12af2073-3418-4a7a-8b2c-e9f91f2234ed', 'eduard.occhipinti@edu.unito.to', '2022-01-05', 'Marco è stato un grande ospite, mi ha aiutato in tutti i progetti', 5, 'Utente');
...
DELETE FROM Alloggio WHERE IDAlloggio = '97c645ea-e19c-411c-8539-5d21def970cc';
...
UPDATE Utente SET email = 'mmolica@edu.unito.to' WHERE Email = 'marco.molica@edu.unito.to'
-- In questo caso l'aggiornamento dell'attributo email comporterà l'aggiornamento a cascata di tutte le tabelle dove è presente una relazione con l'attributo email, per via della clausola ON UPDATE CASCADE.